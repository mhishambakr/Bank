...
<div class="container">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav_links"><a href="login.php">Login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="container" id="login_form">
        <form action="handle_register.php" method="POST">
            ...
            <div class="input-group input-group-lg col-xs-5 center-block">
                <label class="input-group-addon" for="adminPassword">Admin password</label>
                <input type="password" name="adminPassword" class="form-control" id="adminPassword" placeholder="Please enter admin password"><br>
            </div>
            <div class="input-group col-xs-5 center-block">
                <input type="submit" class = "btn btn-success btn-lg col-xs-12" id='submit_button' name="register" value="Register">
            </div>
        </form>
    </div>
</body>
