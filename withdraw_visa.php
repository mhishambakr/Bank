    ...
    <div class='container' id='login_form'>
        <form action='handle_withdraw.php' method='post'>
            <div class='input-group input-group-lg col-xs-5 center-block'>
                <label for='visaNum' class='input-group-addon'>Enter visa number:</label>
                <input type='number' class='form-control' name='visaNum' id='visaNum' pattern='.{10,}'   required title='10 characters minimum'><br>
            </div>
            <div class='input-group input-group-lg col-xs-5 center-block'>
                <label for='visaPassword' class='input-group-addon'>Enter visa password:</label>
                <input type='number' class='form-control' name='visaPassword' id='visaPassword' pattern='.{10,}'   required title='10 characters minimum'><br>
            </div>
            <div class='input-group input-group-lg col-xs-5 center-block'>
